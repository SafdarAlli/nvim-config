  ...
  },
  {
    ...
    config = function()
      ...
      local on_attach = function(client, bufnr)
        ...
        keymap('n', 'gR', '<cmd>Telescope lsp_references<CR>', { desc = 'Show LSP references', buffer = bufnr })
        keymap('n', 'gD', vim.lsp.buf.declaration, { desc = 'Go to declaration', buffer = bufnr })
        keymap('n', 'gd', '<cmd>Telescope lsp_definitions<CR>', { desc = 'Show definitions', buffer = bufnr })
        keymap('n', 'gi', '<cmd>Telescope lsp_implementations<CR>', { desc = 'Show implementations', buffer = bufnr })
        keymap('n', 'gt', '<cmd>Telescope lsp_type_definitions<CR>', { desc = 'Show type definitions', buffer = bufnr })
        keymap({ 'n', 'v' }, '<leader>ca', vim.lsp.buf.code_action, { desc = 'Code action', buffer = bufnr })
        keymap('n', '<leader>rn', vim.lsp.buf.rename, { desc = 'Rename symbol', buffer = bufnr })
        keymap('n', '<leader>D', '<cmd>Telescope diagnostics bufnr=0<CR>', { desc = 'Buffer diagnostics', buffer = bufnr })
        keymap('n', '<leader>d', vim.diagnostic.open_float, { desc = 'Line diagnostics', buffer = bufnr })
        ...
        keymap('n', '<leader>rs', ':LspRestart<CR>', { desc = 'Restart LSP', buffer = bufnr })
